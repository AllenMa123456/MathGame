    ...
    private void mainMenu() {
        ...
        while (playAgain.equals("y")) {
            ...
            if (game.getWinner() != null) {  // check for null just to be safe (so we don't call a method on null)
                ...
                System.out.println(game.getWinner().getName() + " has won " + game.streak() + " game(s) in a row!");
                System.out.println("The current high score is: " + game.highscore() + " games won in a row");
            }
            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
